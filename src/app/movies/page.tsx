                ...
                >
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <span
                      className={
                        movie.watched
                          ? "inline-block rounded-full bg-green-600 px-3 py-1 text-sm font-medium text-white"
                          : "inline-block rounded-full bg-zinc-700 px-3 py-1 text-sm font-medium text-zinc-200"
                      }
                    >
